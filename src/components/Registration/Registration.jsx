...
export const Registration = observer(({ toggleDrawer }) => {
  ...
  return (
    <form className='registration-form' onSubmit={handleRegistration}>
      {!store.isLoading ? 
        (
          <>
            <h3 className='title'>Спробуй нові відчуття</h3>
            <p className='description'>Зареєструйся, щоб грати на максималках у свої улюблені ігри</p>
            <label className='label'>введіть ваш email:
              <input
            ...
            <label className='label'>введіть ваш пароль:
              <input
