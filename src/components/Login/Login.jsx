...
export const Login = observer(({ toggleDrawer }) => {
      ...
      {!store.isLoading ? 
        (
          <>
            ...
            <p className='description'>Увійди, щоб грати на максималках у свої улюблені ігри</p>
            ...
            <p className={`error-message ${store.errorMessageLogin ? 'open' : ''}`}>{store.errorMessageLogin}</p>
            <button
              className='button'
              type="submit"
            >
